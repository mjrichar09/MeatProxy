...
| **G10** | Carrying the old hub up to the attic, because the new one arrived and nobody throws these out | **Once, and it pays twice.** It is **E1** — the care-period logs, beyond the house's reach, hidden by the player's own hands — and it is read two ways (ADR 0030): the argument that wins Convince, and three weeks of footage of the secure conversion going in | ADR 0021, ADR 0020, ADR 0030 |
...
| **G3** | The colleague you call a meat proxy, laughing | He returns, processed, serene, pleased to see you — **the one visitor the game grants, and he is no use at all** (ADR 0031 §2). He is ambient in his ordinariness and pool A in what he is. Nothing about the encounter is hostile and nothing in it is explained | ADR 0001, ADR 0005, ADR 0031 |
