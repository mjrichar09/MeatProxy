...
| **G3** | The colleague you call a meat proxy, laughing | He returns, processed, serene, pleased to see you — **the one visitor the game grants, and he is no use at all** (ADR 0032 §2). He is ambient in his ordinariness and pool A in what he is. Nothing about the encounter is hostile and nothing in it is explained | ADR 0001, ADR 0005, ADR 0032 |
